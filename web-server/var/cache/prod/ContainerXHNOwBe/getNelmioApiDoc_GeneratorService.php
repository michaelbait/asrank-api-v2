...
return $this->services['nelmio_api_doc.generator'] = new \Nelmio\ApiDocBundle\ApiDocGenerator(new RewindableGenerator(function () {
    ...
    yield 1 => ($this->privates['nelmio_api_doc.describers.swagger_php.default'] ?? $this->load('getNelmioApiDoc_Describers_SwaggerPhp_DefaultService.php'));
    yield 2 => ($this->privates['nelmio_api_doc.describers.route.default'] ?? $this->load('getNelmioApiDoc_Describers_Route_DefaultService.php'));
    yield 3 => ($this->privates['nelmio_api_doc.describers.default'] ?? $this->privates['nelmio_api_doc.describers.default'] = new \Nelmio\ApiDocBundle\Describer\DefaultDescriber());
