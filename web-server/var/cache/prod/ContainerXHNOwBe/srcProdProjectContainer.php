...
class srcProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'App\\Api2\\Controller\\AsnController' => 'getAsnControllerService.php',
            'App\\Api2\\Controller\\DatasetController' => 'getDatasetControllerService.php',
            'App\\Api2\\Controller\\LocationController' => 'getLocationControllerService.php',
            'App\\Api2\\Controller\\OrgController' => 'getOrgControllerService.php',
            'App\\Api2\\Controller\\RelationController' => 'getRelationControllerService.php',
            'App\\Controller\\About' => 'getAboutService.php',
            'App\\Controller\\AsCoreController' => 'getAsCoreControllerService.php',
            'App\\Controller\\AsnController' => 'getAsnController2Service.php',
            'App\\Controller\\Contact' => 'getContactService.php',
            'App\\Controller\\FAQ' => 'getFAQService.php',
            'App\\Controller\\Maintenance' => 'getMaintenanceService.php',
            'App\\Controller\\OrgController' => 'getOrgController2Service.php',
            'App\\Controller\\Rest\\AsnRestController' => 'getAsnRestControllerService.php',
            'App\\Controller\\Rest\\DSRestController' => 'getDSRestControllerService.php',
            'App\\Controller\\Rest\\OrgRestController' => 'getOrgRestControllerService.php',
            'App\\Controller\\Sitemap' => 'getSitemapService.php',
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('RESTFUL_DATABASE_URL', $this->getEnv('RESTFUL_DATABASE_URL'));
        $instance->addGlobal('PAGE_NUMBER_RANGE', 3);
    ...
    {
        $a = ($this->privates['monolog.processor.psr_log_message'] ?? $this->privates['monolog.processor.psr_log_message'] = new \Monolog\Processor\PsrLogMessageProcessor());

        $b = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/log/prod.deprecations.log'), 100, true, NULL);
        $b->pushProcessor($a);

        $c = new \Monolog\Handler\FilterHandler($b, 100, 200, true);
        $c->pushProcessor($a);

        $d = new \Symfony\Bridge\Monolog\Logger('php');
        $d->pushHandler($c);
        $d->pushHandler(($this->privates['monolog.handler.console'] ?? $this->privates['monolog.handler.console'] = new \Symfony\Bridge\Monolog\Handler\ConsoleHandler(NULL, true, array())));
        $d->pushHandler(($this->privates['monolog.handler.main'] ?? $this->getMonolog_Handler_MainService()));

        return $this->privates['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, $d, NULL, 0, false, ($this->privates['debug.file_link_formatter'] ?? $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL)), false);
    }
