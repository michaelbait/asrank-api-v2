...
$b = ($this->privates['controller_name_converter'] ?? $this->privates['controller_name_converter'] = new \Symfony\Bundle\FrameworkBundle\Controller\ControllerNameParser(($this->services['kernel'] ?? $this->get('kernel', 1))));

$c = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), ($this->targetDirs[3].'/src/Resources'), array(0 => ($this->targetDirs[3].'/src')));
...
$f->addLoader(new \FOS\RestBundle\Routing\Loader\DirectoryRouteLoader($c, $d));
$f->addLoader(new \FOS\RestBundle\Routing\Loader\RestRouteLoader($this, $c, $b, new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($a, new \FOS\RestBundle\Request\ParamReader($a), new \FOS\RestBundle\Inflector\DoctrineInflector(), true, array('json' => false, 'xml' => false, 'html' => true), true), $a), NULL));
$f->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($c, $d, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$f->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($c, $d, true, array('json' => false, 'xml' => false, 'html' => true), NULL));
$f->addLoader($e);
...
return $this->services['routing.loader'] = new \Symfony\Bundle\FrameworkBundle\Routing\DelegatingLoader($b, $f);
